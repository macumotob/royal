struct LevelConfiguration {
    ...
    static let defaultLevels: [LevelConfiguration] = [
        ...
        LevelConfiguration(
            ...
            startMessage: "Каменная стена! Совпадения рядом с камнем разрушают его.",
            obstacles: [
                (GridPosition(row: 0, column: 2), .chain),
                (GridPosition(row: 0, column: 3), .chain),
                (GridPosition(row: 2, column: 2), .stone(hits: 2, origin: GridPosition(row: 2, column: 2))),
            ]
        ),
        LevelConfiguration(
            number: 23,
        ...
        LevelConfiguration(
            ...
            startMessage: "Камни и лёд объединились! Каждый ход на счету.",
            obstacles: [
                (GridPosition(row: 0, column: 1), .ice(hits: 2)),
                (GridPosition(row: 0, column: 4), .ice(hits: 2)),
                (GridPosition(row: 1, column: 0), .ice(hits: 2)),
                (GridPosition(row: 1, column: 5), .ice(hits: 2)),
                (GridPosition(row: 2, column: 2), .stone(hits: 3, origin: GridPosition(row: 2, column: 2))),
                (GridPosition(row: 4, column: 0), .ice(hits: 2)),
                (GridPosition(row: 4, column: 5), .ice(hits: 2)),
                (GridPosition(row: 5, column: 1), .ice(hits: 2)),
                (GridPosition(row: 5, column: 4), .ice(hits: 2)),
        ...
        LevelConfiguration(
            ...
            startMessage: "14 преград! Камни, лёд и цепи — ваше последнее испытание.",
            obstacles: [
                (GridPosition(row: 0, column: 0), .ice(hits: 2)),
                (GridPosition(row: 0, column: 2), .chain),
                (GridPosition(row: 0, column: 3), .chain),
                ...
                (GridPosition(row: 1, column: 4), .ice(hits: 1)),
                (GridPosition(row: 2, column: 2), .stone(hits: 3, origin: GridPosition(row: 2, column: 2))),
                (GridPosition(row: 4, column: 0), .stone(hits: 2, origin: GridPosition(row: 4, column: 0))),
                (GridPosition(row: 4, column: 4), .chain),
                (GridPosition(row: 5, column: 4), .chain),
                (GridPosition(row: 5, column: 2), .ice(hits: 1)),
            ]
        ),
        LevelConfiguration(
            number: 30,
